...
main(){
	...
	cout<<"\t* E- Platea *"<<endl;
	cout<<"\t****************************************"<<endl;
	cout<<"\n\t Selecciona la letra del sector del estadio: "<<endl;
	opcion=getche();
	cout<<"\n\t Ingresa la cantidad de entradas requeridas: "<<endl;
	cin>>cantidad;
	if(cantidad<1){
	...
	switch(opcion){
		case 'A': case 'a':
		cout<<"\n\t Sector selecionado: Sol general"<<endl;
		precio=3;
		break;
		case 'B': case 'b':
		cout<<"\n\t Sector selecionado: Sol preferente"<<endl;
		precio=5;
		break;
		case 'C': case 'c':
		cout<<"\n\t Sector selecionado: Sombra"<<endl;
		precio=8;
		break;case 'D': case 'd':
		cout<<"\n\t Sector selecionado: Tribuna"<<endl;
		precio=15;
		break;case 'E': case 'e':
		cout<<"\n\t Sector selecionado: Platea"<<endl;
		precio=20;
		break;
		default:
